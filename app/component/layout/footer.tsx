		...
		!login && (
			<footer className=' dark:text-blue-100 border-t-2 border-third dark:border-darksecoundry mt-20'>
				<div className='mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8'>
						...
						<div className='grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left'>
							<div>
								...
								<ul className='mt-6 space-y-1'>
									<li>
										<a
											className='text-gray-700 transition dark:text-gray-300 hover:text-gray-700/75'
											href='#'>
											{' '}
											Marketing{' '}
										</a>
					...
					<div className='mt-16 border-t border-gray-100 dark:border-gray-600 pt-8'>
						<p className='text-center text-xs/relaxed text-gray-500 dark:text-gray-400'>
							...
							<a
								href='#'
								className='text-gray-600 dark:text-gray-300 underline transition hover:text-gray-700/75'>
								Laravel
							</a>
							and
							<a
