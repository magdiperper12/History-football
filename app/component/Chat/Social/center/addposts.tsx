...
function Addposts() {
	return (
		<div className='w-auto  bg-white dark:bg-darkprimary dark:text-primary rounded-lg shadow-md mx-3 md:px-4 py-3 '>
				...
				<div className='w-[80%] md:w-[90%] lg:w-[95%]'>
					<div className='w-full flex justify-center items-end'>
						<textarea
							name=''
							id=''
							className='w-full bg-slate-100 dark:bg-darksecoundry dark:text-primary rounded-lg outline-none  p-1 px-2'
							placeholder='what is your mind ..?'></textarea>
						<div>
							<BsEmojiSmileFill className='text-yellow-600 dark:text-yellow-500 text-xl mx-1 ' />
						</div>
					</div>
					<div className='w-full gap-2 md:gap-4 text-sm md:text-md  py-3 text-gray-500 dark:text-gray-200 cursor-pointer  flex px-2 md:px-5 justify-start items-end'>
