	...
	return (
		<div className='w-full md:max-w-screen-md m-auto p-4 rounded-lg'>
			...
			<div className='relative'>
				...
				{dropdownVisible && (
					<ul className='absolute bg-darkthird dark:bg-darksecoundry  rounded-lg mt-2 w-48 z-10'>
						{leagues.map((league) => (
							<li
								key={league.id}
								className='p-2 hover:bg-gray-100 text-primary dark:text-secoundry hover:text-darksecoundry cursor-pointer'
