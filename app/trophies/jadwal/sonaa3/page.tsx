	...
	return (
		<div className='container mx-auto  py-6 w-full px-2 bg-blue-50  dark:bg-blue-900'>
			...
			<div className='overflow-x-auto'>
				<table className='min-w-full bg-blue-100 dark:bg-blue-960  rounded-lg shadow-md'>
					<thead>
							...
							<tr
								...
								<td className='p-4 text-start flex items-center justify-start space-x-2 w-full'>
									...
									<Image
										...
										height={48}
									/>
									<span className='text-blue-800 dark:text-blue-100 font-medium text-sm md:text-base text-nowrap '>
										{player.name}
									</span>
								</td>
								<td className='p-4 text-start text-blue-800 dark:text-blue-100 text-sm md:text-base'>
									{player.club}
								</td>
